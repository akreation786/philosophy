                    ...
                    <div class="featured__column featured__column--big">
                        <div class="entry" style="background-image:url('<?php echo esc_url($post_data[0]["thumbnail"]) ?>');">
                            ...
                            <div class="entry__content">
                                ...
                                <h1><a href="<?php echo esc_url($post_data[0]["permalink"]) ?>" title="<?php echo esc_attr($post_data[0]["title"]) ?>"><?php echo esc_html($post_data[0]["title"]) ?></a></h1>

                                <div class="entry__info">
                                    <a class="bypostauthor" href="<?php echo esc_url($post_data[0]["author_url"]) ?>" class="entry__profile-pic">
...
<div class="entry__content">
    ...
    <h1><a href="<?php echo esc_url($post_data[$i]["permalink"]) ?>" title="<?php echo esc_attr($post_data[$i]["title"]) ?>"><?php echo esc_html($post_data[$i]["title"]) ?></a></h1>
